...
public:
    ...
    ErrorCode addFile(const QString& path, const QString& root, Zip::CompressionLevel level);
    ErrorCode addFile(QIODevice& buff, const QString& entryName, Zip::CompressionLevel level);
